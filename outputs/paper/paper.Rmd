...
In Figure [] below, we can see that the distribution is largely skewed towards families with income less than $50,000:
```{r}
...
racegraph
```
Looking at the distribution of race, we can see that 75% of the respondants from the survey are white. Since the distribution does not represent minorities, we can justify using post stratification. 
